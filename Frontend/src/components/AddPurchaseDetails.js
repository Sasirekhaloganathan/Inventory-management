...
export default function AddPurchaseDetails({
  ...
  useEffect(() => {
    ...
    const cost = parseFloat(purchase.costPerUnit);
    if (!isNaN(quantity) && !isNaN(cost)) {
      setPurchase((prev) => ({
        ...prev,
        totalPurchaseAmount: (quantity * cost).toFixed(2),
      }));
    } else {
      setPurchase((prev) => ({
        ...prev,
  ...
  }, [purchase.quantityPurchased, purchase.costPerUnit]);
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      <form>
                        <div className="grid gap-4 mb-4 sm:grid-cols-2">
                          ...
                          <div>
                            <label htmlFor="costPerUnit" className="block mb-2 text-sm font-medium text-gray-900">
                              Cost Per Unit
                            </label>
                            <input
                              type="number"
